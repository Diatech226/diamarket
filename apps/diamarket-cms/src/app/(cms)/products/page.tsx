...
export default function ProductsPage() {
  ...
  const upload = async (files: FileList | null) => {
    ...
    try {
      ...
      setMedia(await cmsService.getMedia());
    } catch (err) { setError((err as Error).message); } finally { setSaving(false); }
  };
