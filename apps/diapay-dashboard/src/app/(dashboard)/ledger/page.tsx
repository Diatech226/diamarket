...
export default function LedgerPage() {
  return <><PageHeader title="Ledger comptable" description="Journal double entrée immutable: aucune modification historique, uniquement des écritures append-only et snapshots de balance. Source temporaire in-memory pour audit sandbox; la source de vérité cible reste une base transactionnelle." />
