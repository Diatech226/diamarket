...
export default function WalletsPage() {
  return <><PageHeader title="Wallets marketplace" description="Suivez les merchant_wallet, vendor_wallet, platform_wallet, escrow_wallet et reserve_wallet par devise et propriétaire. Vue wallet issue du ledger in-memory temporaire; non production-ready." />
