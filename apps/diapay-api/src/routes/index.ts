...
import { deleteApiKey, getApiKeys, listAdmins, listApps, listLogs, listMerchants, postAdmin, postApiKey, postApp, postMerchant, rotateKey, getApp, patchApp, deleteApp } from '../controllers/developer-platform';
import { apiKeyAuthMiddleware } from '../modules/api-keys/api-key-auth.service';
...
apiRouter.get('/apps/:id', getApp);
apiRouter.patch('/apps/:id', patchApp);
apiRouter.delete('/apps/:id', deleteApp);
apiRouter.get('/applications', listApps);
apiRouter.post('/applications', postApp);
apiRouter.get('/applications/:id', getApp);
apiRouter.patch('/applications/:id', patchApp);
apiRouter.delete('/applications/:id', deleteApp);
