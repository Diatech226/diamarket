...
const TransportPricingSchema = new mongoose.Schema(
  {
    transportType: {
      type: String,
      required: true,
      enum: ['air', 'sea', 'road', 'express', 'rail', 'drone', 'camion', 'train'],
    },
    allowedUnits: { type: [String], enum: ['kg', 'm3', 'flat'], default: ['kg'] },
    unitType: { type: String, enum: ['kg', 'm3', 'flat'], required: true },
    pricePerUnit: { type: Number, default: null },
    pricePerKg: { type: Number, default: null },
    pricePerM3: { type: Number, default: null },
    flatPrice: { type: Number, default: null },
    minimumPrice: { type: Number, default: null },
    minDelayDays: { type: Number, default: null },
    maxDelayDays: { type: Number, default: null },
    volumetricDivisor: { type: Number, default: null },
    additionalServices: {
      insurance: { type: Number, default: 0 },
      pickup: { type: Number, default: 0 },
      homeDelivery: { type: Number, default: 0 },
