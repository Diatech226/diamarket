...
const labels: Record<string, string> = { services: 'service', 'popular-routes': 'route populaire', faq: 'FAQ' };
...
export function CmsCrud({ resource }: { resource: 'services' | 'popular-routes' | 'faq' }) {
